        ...
        {track.artists.map((artist, index) => {
          ...
          return (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="transition-color duration-500 font-normal text-sm text-coolGray-600 dark:text-coolGray-500 leading-none hover:text-pink-500 dark:hover:text-pink-400"
              key={artist.id}
            >
              {string}
            </a>
